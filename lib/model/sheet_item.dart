...
class SheetItem {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (id != null && id!.isNotEmpty) sheetItemJson["id"] = id;
    if (title != null) sheetItemJson["title"] = title;
    if (sValue != null && sValue!.isNotEmpty) sheetItemJson["sValue"] = sValue;
    if (dValue != null) sheetItemJson["dValue"] = dValue;
    if (sheetItemType != null) sheetItemJson["sheetItemType"] = sheetItemType;
    if (extraValue != null) sheetItemJson["extraValue"] = extraValue;
