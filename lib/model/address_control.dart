...
class AddressControl extends SheetControl {
  ...
  factory AddressControl.fromJson(Map<String, dynamic> json, SheetUpdatedListener? sheetUpdatedListener) {
    ...
    if (SheetItem.fromJson(json["sheetItem"]).sheetItemType.toString() == SheetItemType.SHIPPING_ADDRESS.name) addressControl.setDisplayOption(json["displayOption"] as int);
  ...
  Map<String, dynamic> toJson() {
    ...
    if (sheetItem != null) addressControl["sheetItem"] = sheetItem?.toJson();
    if (address != null) addressControl["address"] = address?.toJson();
    if (displayOption != null) addressControl["displayOption"] = displayOption;
    if (errorCode != null) addressControl["errorCode"] = errorCode;
