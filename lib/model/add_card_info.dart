...
class AddCardInfo {
  ...
  /// Indicates that the card tokenization provider is ELO.
  ///

  static const String PROVIDER_ELO = "ELO";

  /// Indicates that the card tokenization provider is MADA.
  ///

  static const String PROVIDER_MADA = "MADA";
  ...
  static final List<String> allowedCardTypes = [WalletCard.CARD_TYPE_CREDIT_DEBIT, WalletCard.CARD_TYPE_CREDIT, WalletCard.CARD_TYPE_DEBIT, WalletCard.CARD_TYPE_VACCINE_PASS];
